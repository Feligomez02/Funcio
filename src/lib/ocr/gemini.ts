...
function buildInstruction(input: OcrBatchInput) {
  ...
  return [
    ...
    "Incluye referencias a Casos de Uso (CU-xxx), Historias de Usuario (HU-xxx) u otros identificadores asociados si describen el mismo objetivo.",
    "Ignora secciones como \"Pendientes\", \"Notas\" u otros encabezados informativos que no sean requerimientos.",
